...
model.load_state_dict(torch.load("model_save.pth", map_location='cpu'))
...
for frame_idx in range(1, num_frames + 1):
    ...
    if frame_idx % 50000 == 0:
        ...
        pickle_losses = open("losses.pickle", "wb")
        pickle.dump(losses, pickle_losses)
        pickle_losses.close()

        pickle_all_rewards = open("all_rewards.pickle", "wb")
        pickle.dump(all_rewards, pickle_all_rewards)
        pickle_all_rewards.close()
